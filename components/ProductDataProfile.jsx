...
const ProductDataProfile = React.memo(
  ({ data, deleteProduct, updateProduct, isSubmitting }) => {
          ...
          <div>
            <div className="grid grid-cols-1  lg:grid-cols-2 p-2 gap-1  text-orange bg-white rounded-md tracking-tight mx-5 text-gray-700 font-medium ">
              ...
              <div className="flex flex-col  p-2 rounded-md lg:justify-center lg:gap-4">
                ...
                <span className="flex justify-between flex-initial w-800 mb-3   ">
                  ...
                  <span className="flex gap-4 items-center">
                    ...
                    <Image
                      ...
                      onClick={navigateToUserHandler.bind(
                        null,
                        data.creator._id
                      )}
                    />
                ...
                <div className="flex flex-col justify-center items-center border text-white">
                  <h3>Description</h3>
